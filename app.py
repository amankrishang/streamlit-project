...
options = st.sidebar.radio("Options", ("Medal-Tally", "Country-Wise", "Year-wise", "Year-Wise Progress", "Sport"))
...
if season=="Summer" and options=="Medal-Tally":
    ...
    selected_country = st.selectbox("Choose Country To check progress", countries)
